				...
				<ul class="menu">
					...
					<li  ><a href="movimientos.php"><i class="icono izquierda glyphicon glyphicon-sort-by-alphabet" ></i>Movimientos</a></li>
					...
					<li  ><a href="logout.php"><i class="icono izquierda glyphicon glyphicon-user" ></i>Cerrar Sesión</a></li>
				</ul>