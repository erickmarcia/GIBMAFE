...
<head>
    ...
    <title>Clientes | Simple Invoice</title>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class=""><a href="facturas.php"><i class="glyphicon glyphicon-list-alt"></i> Facturas <span class="sr-only">(current)</span></a></li>
        <li class=""><a href="productos.php"><i class="glyphicon glyphicon-barcode"></i> Productos</a></li>
		<li class="active"><a href="clientes.php"><i class="glyphicon glyphicon-user"></i> Clientes</a></li>
    ...
    <div class="container">
      <p class="navbar-text pull-left">© 2017 - Obed Alvarado.
	...
	<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js" integrity="sha384-0mSbJDEHialfmuBBQP6A4Qrprq5OVfW37PRR3j5ELqxss1yVqOtnepnHVP9aJ7xS" crossorigin="anonymous"></script>	<script type="text/javascript" src="js/clientes.js"></script>
